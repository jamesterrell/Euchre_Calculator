...
@njit
def round1(hands_dealt: np.ndarray, chosen_card: int, leader: int):
    """
    ...
    branch = n_play_round(hands=hands_dealt, lead=leader, card_play=chosen_card)
    ...
    for i in branch:
        ...
        rd1_winner = n_find_winner(trick=i, lead=leader)
